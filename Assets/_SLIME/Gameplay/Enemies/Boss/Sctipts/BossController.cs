...
{
    public class BossController : ProjectMonoBehavior
    {
        ...
        [Header("Core References")] public Transform bossRoot;
        public Collider2D bossCollider;
        public Camera mainCamera;

        [Header("Movement Path")] public Transform startPoint;
        public Transform endPoint;

        [Header("Spline Hand Attack Setup")] public List<GameObject> leftHandSplines;
        ...
        [Header("Projectiles")] public GameObject fallingItemPrefab;
        public Transform spawnAreaLeft;
        public Transform spawnAreaRight;

        [Header("Health")] public Image bossHealthBar;
        public float maxHealth = 100f;
        [HideInInspector] public float currentHealth;

        [Header("Animation")] [SerializeField] private Animator animator;

        [Header("Laser Array Attack Setup")] public LaserAttackLogic laserArrayScript;
